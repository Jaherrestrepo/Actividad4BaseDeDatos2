...
CREATE TABLE `oficina` (
  ...
  `Descripcion` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `ciudad` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
