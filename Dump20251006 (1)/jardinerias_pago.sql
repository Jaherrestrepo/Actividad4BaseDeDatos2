...
CREATE TABLE `pago` (
  ...
  `forma_pago` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `id_transaccion` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
