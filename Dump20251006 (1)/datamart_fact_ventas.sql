...
CREATE TABLE `fact_ventas` (
  ...
  `ID_producto` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  KEY `fecha` (`fecha`),
  CONSTRAINT `fact_ventas_ibfk_1` FOREIGN KEY (`ID_cliente`) REFERENCES `dim_cliente` (`ID_cliente`),
  CONSTRAINT `fact_ventas_ibfk_2` FOREIGN KEY (`ID_producto`) REFERENCES `dim_producto` (`ID_producto`),
  CONSTRAINT `fact_ventas_ibfk_3` FOREIGN KEY (`fecha`) REFERENCES `dim_tiempo` (`fecha`)
